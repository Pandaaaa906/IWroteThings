...
class Context(object):
    ...
    def scope(self, cleanup=True):
        ...
        The default behavior of this is to invoke the cleanup my_module which
        can be disabled by setting `cleanup` to `False`.  The cleanup
        my_module are typically used for things such as closing file handles.
        ...
        :param cleanup: controls if the cleanup my_module should be run or
                        not.  The default is to run these my_module.  In
